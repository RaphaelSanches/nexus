<?php
	...
	$experimentos_result = mysql_query("SELECT obras.nome, obras.cod_obra, img.cod_obra, img.nome FROM obras INNER JOIN img ON img.cod_obra = obras.cod_obra WHERE img.destaque = 1 ") or die(mysql_error());
	...
	<section class="container cf" role="main">
		...
		<ul class="artistas-list cf">
 			<?php
				...
				?>
					<a href="experimento-individual.php?cod_autor=<?php echo $row['cod_obra'] ?>" class="experimentos-item">
						<img src="assets/img/content/obra">
